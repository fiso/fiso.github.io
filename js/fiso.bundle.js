...
var fiso = {
  ...
  scrollThrottler: function scrollThrottler(e) {
    var _this = this;
  ...
  querySelectorAllCached: function querySelectorAllCached(query) {
    if (!this.querySelectorAllCache[query]) {
      this.querySelectorAllCache[query] = Array.prototype.slice.call(document.querySelectorAll(query));
    }
  ...
  scrollTo: function scrollTo(to, speed) {
    var element = this.getScrollElement();
    var start = element.scrollTop;
    var change = to - start;
    var increment = 20;
    var duration = Math.abs(change / speed * 300);

    var animateScroll = function (elapsedTime, cb) {
  ...
  getCurrentHeaderHeight: function getCurrentHeaderHeight() {
    var header = this.querySelectorCached("body > header");
...
//# sourceMappingURL=fiso.bundle.js.map